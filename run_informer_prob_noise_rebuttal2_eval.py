...
# ## DeepED Informer
# Used on 8.15.2024 for NeurIPS rebuttal. 
# Originally copied from run_informer_full_noise.py. Do not know why use full attention for informer. 
# changed to prob sparse attention here. 
# tasks: different batch size and learning rate.
...
setting = '{}_{}_ft{}_sl{}_ll{}_pl{}_asi{}_aei{}_dm{}_nh{}_el{}_dl{}_df{}_at{}_fc{}_eb{}_dt{}_mx{}_{}_{}_noise{}_rebuttal_bs400'.format(args.model, args.data, args.features,
...
# load checkpoint
ckp = torch.load(exp.args.checkpoints+'/'+setting+'/'+'checkpoint.pth')
exp.model.load_state_dict(ckp)
exp.model.eval()
