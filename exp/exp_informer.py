from data.data_loader import Dataset_ETT_hour, Dataset_ETT_minute, Dataset_Custom, Dataset_Pred, Dataset_DeepED, Dataset_DeepED_Climate
...
class Exp_Informer_DeepED_Climate(Exp_Basic):
    def __init__(self, args):
        super(Exp_Informer_DeepED_Climate, self).__init__(args)
    ...
    def _get_data(self, flag):
        ...
        data_dict = {
            ...
            'deeped_climate': Dataset_DeepED_Climate,
        }
